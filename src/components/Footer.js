...
export const Footer = () => {
  return (
    <div className="h-56 bg-neutral-800 flex flex-wrap gap-16 justify-center items-center p-4">
      <div className="flex flex-col gap-4 text-lg font-bold px-4">
        <span>Mobile: +918105766761</span>
        <span>Email: akshayvarmamit@gmail.com</span>
      </div>
